                ...
                if(resultCode == RESULT_OK){
                    try{
                        ...
                        if(imageUri != null){
                            ...
                            mFace= facesUtil.getFacesInfo(imageByte);
//                            faceMakeUpUtils.setARGB(100,20,20,20);
//                            bitmap = faceMakeUpUtils.eyebrowRendering(bitmap,face);
//                            bitmap = faceMakeUpUtils.drawEyePoint(bitmap,face);
                            //faceMakeUpUtils.mouthMaskTexture(this,bitmap,face);
    ...
    private Bitmap drawFace(Face face,String index){
        ...
        switch(index){
            ...
            case "紫色":
                ...
                break;
            default:
                faceMakeUpUtils.setARGB(120,180,20,10);
                break;
        }
        bitmap = faceMakeUpUtils.mouthRendering(mbitmap,face);
        return bitmap;
    }
}